## Welcome to  [ # Holiday Feature Folding Cards ]  HTML Code Sections
A small "holiday deals" page focusing on folding cards' design and functionality, only using HTML and CSS.
## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/Holiday-Feature-Folding-Cards )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/xxmqrML )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/Holiday-Feature-Folding-Cards )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/Travel-video-landing-page/ )
